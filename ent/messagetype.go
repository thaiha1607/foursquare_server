...
func (*MessageType) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case messagetype.FieldCreatedAt, messagetype.FieldUpdatedAt:
...
func (mt *MessageType) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the MessageType.
// This includes values selected through modifiers, order, etc.
func (mt *MessageType) Value(name string) (ent.Value, error) {
...
func (mt *MessageType) Update() *MessageTypeUpdateOne {
	return NewMessageTypeClient(mt.config).UpdateOne(mt)
}
...
func (mt *MessageType) String() string {
	...
	builder.WriteString(mt.MessageType)
	builder.WriteByte(')')
