...
const (
	// Label holds the string label denoting the invoicetype type in the database.
	Label = "invoice_type"
	...
	// Table holds the table name of the invoicetype in the database.
	Table = "invoice_types"
)

// Columns holds all SQL columns for invoicetype fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the InvoiceType queries.
