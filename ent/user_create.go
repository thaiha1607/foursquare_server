...
func (uc *UserCreate) SetAvatarURL(u *url.URL) *UserCreate {
	uc.mutation.SetAvatarURL(u)
	return uc
}
...
func (uc *UserCreate) SetOtherAddressInfo(s string) *UserCreate {
	uc.mutation.SetOtherAddressInfo(s)
	return uc
}

// SetNillableOtherAddressInfo sets the "other_address_info" field if the given value is not nil.
func (uc *UserCreate) SetNillableOtherAddressInfo(s *string) *UserCreate {
	if s != nil {
		uc.SetOtherAddressInfo(*s)
	}
	return uc
}
...
func (uc *UserCreate) SetUserRoleID(id int) *UserCreate {
	uc.mutation.SetUserRoleID(id)
	return uc
}

// SetUserRole sets the "user_role" edge to the UserRole entity.
func (uc *UserCreate) SetUserRole(u *UserRole) *UserCreate {
	return uc.SetUserRoleID(u.ID)
}
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.UserRoleID(); !ok {
		return &ValidationError{Name: "user_role", err: errors.New(`ent: missing required edge "User.user_role"`)}
	}
	return nil
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.UserRoleIDs(); len(nodes) > 0 {
