...
const (
	// Label holds the string label denoting the shipmentstatuscode type in the database.
	Label = "shipment_status_code"
	...
	// Table holds the table name of the shipmentstatuscode in the database.
...
var (
	...
	// ShipmentStatusValidator is a validator for the "shipment_status" field. It is called by the builders before save.
	ShipmentStatusValidator func(string) error
