...
const (
	// Label holds the string label denoting the orderstatuscode type in the database.
	Label = "order_status_code"
	...
	// Table holds the table name of the orderstatuscode in the database.
