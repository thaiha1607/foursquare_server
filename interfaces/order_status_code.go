...
type OrderStatusCodeService interface {
	...
	Update(ctx context.Context, id int, obj *ent.OrderStatusCode) (*ent.OrderStatusCode, error)
	Store(ctx context.Context, obj *ent.OrderStatusCode) (*ent.OrderStatusCode, error)
